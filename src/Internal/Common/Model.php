...
class Model implements \ArrayAccess, \IteratorAggregate, \Countable, ToArrayInterface
{
     ...
     *
     * @param array|null $keys Pass an array of keys to retrieve only a subset of key value pairs
     *
     ...
     *
     * @param mixed $data Associative array of key value pair data
     *
     * @return $this Returns a reference to the object.
     */
     ...
     *
     * @param array|string $path Path to traverse and retrieve a value from
